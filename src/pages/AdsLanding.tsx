      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-[1.2] tracking-tight mb-6">
              {isAr ? 'ركز على المبيعات والتسويق،' : 'Concentrez-vous sur les Ventes,'} <br className="hidden sm:block" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400 pb-2">{isAr ? 'وخلي الإنتاج علينا.' : "On s'occupe de la Production."}</span>
            </h1>
