...
const DEFAULT_FAQ: FaqItem[] = [
  ...
  { id: '2', emoji: '📦', category: 'prix', questionFr: 'Quel est le minimum de commande (MOQ) ?', questionAr: 'ما هو الحد الأدنى للطلب؟', answerFr: 'Notre minimum est généralement 100 pièces par modèle/coloris. Pour les échantillons, on peut descendre à 1 pièce.', answerAr: 'الحد الأدنى عادةً 100 قطعة لكل نموذج/لون. للعينات يمكن طلب قطعة واحدة.' },
