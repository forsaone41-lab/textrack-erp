...
import {
  ...
  TrendingDown, LogOut, ShieldCheck, HardHat, BarChart3,
} from 'lucide-react';
      ...
      <div className="px-4 py-3 border-t border-slate-700/50">
        ...
        >
          ...
          <div className="w-8 h-4 bg-slate-600 rounded-full relative flex-shrink-0">
            <div className={`w-3 h-3 bg-indigo-400 rounded-full absolute top-0.5 transition-all ${lang === 'ar' ? 'right-0.5' : 'left-0.5'}`} />
          </div>
        </button>
      </div>
