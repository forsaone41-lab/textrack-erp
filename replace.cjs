...
// Fix isAr usage for rtl/ltr
content = content.replace(/{isAr \? 'rtl' : 'ltr'}/g, "{lang === 'ar' ? 'rtl' : 'ltr'}");
content = content.replace(/dir={isAr \? 'rtl' : 'ltr'}/g, "dir={lang === 'ar' ? 'rtl' : 'ltr'}");
content = content.replace(/dir={isAr \? 'auto' : 'ltr'}/g, "dir={lang === 'ar' ? 'auto' : 'ltr'}");
